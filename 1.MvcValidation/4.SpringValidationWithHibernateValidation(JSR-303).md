...
-	Form Validation using JSR-303 validation annotations and hibernate-validators
-	internationalization support using MessageSource 
- 	Accessing static resources (e.g. CSS, javascript, images) in our views using ResourceHandlerRegistry
